...
const MemoryGame = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% ... p-4">
      ...
      <button
        ...
        className="mt-4 px-4 py-2 bg-green-500 rounded-lg text-white  hover:bg-green-600 transition-colors"
      >
